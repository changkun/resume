...
\listItem{
    ...
    \emph{The Human in the Infinite Loop: A Case Study on Revealing and Explaining Human-AI Interaction Loop
    Failures}.
    In Mensch und Computer 2022 (MuC'22). ACM, New York, NY, USA, 14 pages.
}
\listItem{
