...
\item{
  I have good skills in web development and machine learning.
  and I can use the following languages:
  \textbf{go}; \textbf{python}; \textbf{javascript}; \textbf{c/c++ (for optimization)}; 
