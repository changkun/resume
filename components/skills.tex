...
\ifthenelse{\boolean{en}} {
  \small
  The following outlines years of experience and provides an estimated proficiency level:
  \resumeSubHeadingListStart
  \item{\textbf{Domain}:
  \emph{LLM-based AI} (2 years of industry practice, \emph{experienced});
  ...
  \emph{Machine learning} (1 year of Masters level teaching at university, 2 years of industrial practices,
  % Andrew Ng's Deep Learning Specialization Certificate (ID: \href{https://www.coursera.org/account/accomplishments/specialization/QGH8ZVJ6J2L2}{QGH8ZVJ6J2L2}),
  sklearn/tensorflow/pytorch/etc, \emph{experienced});
  \emph{Data analysis} (3 years of PhD research, numpy/seaborn/pandas/etc., 2 years of industrial data analysis, \emph{experienced});
  \emph{Web development} (2 years of industrial backend engineering, Go/React/etc., \emph{experienced}).
  }
  \item{\textbf{Language}:
  \emph{Go} (9+ years, \emph{expert});
  \emph{Python} (7+ years, \emph{experienced});
  \emph{\LaTeX} (10+ years, \emph{expert});
  \emph{C/C++} (5+ years, \emph{intermediate});
  \emph{JavaScript/TypeScript} (5+ years, \emph{intermediate});
