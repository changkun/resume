...
\section{Publications}
 \resumeSubHeadingListStart
   \item{
      ...
      Advanced Seminar Deep Learning, IFI LMU, 2018. \href{https://github.com/changkun/generalization-dl/blob/master/beamer/generalization.pdf}{English}.
   }
   \item{
    Changkun Ou.
     \emph{An Introduction to Recent Mobile Affective Inferring Techniques: Methods, Applications and Their Challenges}.
     Advanced Seminar Media Computer Science, IFI LMU, 2018. \href{https://github.com/changkun/hs-ws17-affective-computing/blob/master/src/lmumihs-ou.pdf}{English}.
   }
   \item{
