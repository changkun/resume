...
\section{Skills}
 \resumeSubHeadingListStart
   ...
   \item{
    \textbf{Systems/Tools:}{ 
      Mac user; General Linux DevOps;
      Docker; AWS/DigitalOcean/Aliyun; 
      SQL/MongoDB/Redis; 
      zsh/tmux/vim/vscode; 
      Sketch/PS/PR/AE/AU
    }
   ...
   \item{
    \textbf{Frameworks:}{ 
      numpy/opencv/matplotlib/skearn/tensorflow/keras, 
      flask/django, 
      jquery/react/vue/polymer/electron, 
      node/express
    }
   }
   \item{
       ...
       \resumeItemListStart
        ...
        \resumeItem{Machine Side}
          { 
            ...
            Big Data Mining; Computer Vision; 
